 ...
 */
package com.mohoo.dingtalk.base.exception;
...
public class ApplicationError extends Exception {
	 ...
	 *            异常详细信息
	 */
	public ApplicationError(String message, String detail) {
		super(message);
		this.detail = detail;
		this.setInfType(INFTYPE_WARNING);
	 ...
	 *            信息类型
	 */
	public ApplicationError(String message, int infType) {
		super(message);
	 ...
	 *            信息类型
	 */
	public ApplicationError(Throwable cause, int infType) {
		super(cause);
		this.setInfType(infType);
	 ...
	 *            信息类型
	 */
	public ApplicationError(String message, Throwable cause, int infType) {
		super(message, cause);
		this.setInfType(infType);
	 ...
	 * @return 是否显示详细信息
	 */
	public ApplicationError setShowDetial(boolean showdetial) {
